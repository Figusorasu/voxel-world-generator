...
public class MeshData {
	...
	public void AddQuadTriangles(bool quadGeneratesCollider) {
		//Creates first triangle based on index of vertices in list
		triangles.Add(vertices.Count - 4);
		triangles.Add(vertices.Count - 3);
		triangles.Add(vertices.Count - 2);
		
		//Creates second triangle based on index of vertices in list
		triangles.Add(vertices.Count - 4);
		triangles.Add(vertices.Count - 2);
		triangles.Add(vertices.Count - 1);
		
		//does same but for collider triangles
